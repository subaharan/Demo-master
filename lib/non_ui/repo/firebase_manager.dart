...
class FirebaseManager {
  ...
  CollectionReference get tasksRef => FirebaseFirestore.instance.collection('tasks');
  ...
  List<Task> getFullTask(){
    Stream<QuerySnapshot<Object>> messages = tasksRef.snapshots();
  }
