...
import 'non_ui/modal/demo_model.dart';
...
void main() async {
  ...
  Hive.registerAdapter(DemoModelAdapter());
  Hive.init((await getApplicationDocumentsDirectory()).path);
  await Hive.openBox<DemoModel>('demo');
  ...
  runZonedGuarded(() {
    ...
    print('runZonedGuarded: Caught error in my root zone. ${error.toString()} - ${stackTrace.toString()}');
  });
}
